...
This is the software requirements file for scikit-surgerytrackervisualisation, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerytrackervisualisation does. Each requirement can be matched to a unit test that
